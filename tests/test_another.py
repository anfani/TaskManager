"""
Модуль тестов для приложения Task Manager.

Содержит тесты для проверки:
- Аутентификации пользователей и доступа к защищённым маршрутам.
- Валидации ввода данных, таких как задачи и пользователи.
- Работы основных маршрутов, включая главную страницу и страницу описания задач.

Тесты используют APIClient для имитации HTTP-запросов.
"""
