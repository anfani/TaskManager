"""
Модуль тестов API для приложения Tasks.

Содержит тесты для проверки функциональности API управления задачами, включая:
- Создание новых задач.
- Получение списка задач.
- Обновление данных задачи.
- Удаление задачи.

Тесты используют APIClient для отправки HTTP-запросов и проверки корректности ответов.
"""
